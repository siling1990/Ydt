 ...
 * 
 */
public class AddMediaActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String mrcStr = StringUtil.getInfo(AddMediaActivity.this, "record", "");
	...
	public void onClick(View view) {
		...
		case R.id.natives:
			myCaptureFile = FileUtil
					.refileG(AddMediaActivity.this, filter, src);
		...
		case R.id.pai:
			...
			break;
		case R.id.yuyin:
			intent = new Intent(AddMediaActivity.this, RecorderActivity.class);
			...
			break;
		case R.id.wenzi:
			intent = new Intent(AddMediaActivity.this, IatActivity.class);
			intent.putExtra("src", src);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == Constants.PHOTORESOULT) {
			...
			if (extras != null) {
				...
				// 自动生成图片
				img = new ImageView(AddMediaActivity.this);
				img.setTag(src);
				...
				try {
					if (myCaptureFile == null) {
						myCaptureFile = FileUtil.refileG(AddMediaActivity.this,
								filter, src);
					}
					if (Environment.getExternalStorageState().equals(
						...
						Toast toast = Toast.makeText(AddMediaActivity.this,
