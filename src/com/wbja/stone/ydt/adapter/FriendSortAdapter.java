...
public class FriendSortAdapter extends BaseAdapter implements SectionIndexer{
	...
	public FriendSortAdapter(Context mContext, List<Friend> list) {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if(StringUtil.getInfo(mContext, Constants.USERID, "0").equals(this.list.get(position).getId_user())){
			viewHolder.tvTitle.setText(this.list.get(position).getDisplayname_friend());
		}else{
			viewHolder.tvTitle.setText(this.list.get(position).getDisplayname_user());
		}
