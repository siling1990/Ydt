...
public class ClinicRecordByDateActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent=getIntent();
		schDate=intent.getStringExtra("date");
		
		db = new DB(ClinicRecordByDateActivity.this);
		...
		headMore.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent = new Intent(ClinicRecordByDateActivity.this,
	...
	private void initUI() {
		intent = new Intent(ClinicRecordByDateActivity.this, TabShowMRCActivity.class);
		recordList = db.queryMRCByDate(schDate,StringUtil.getID_User(ClinicRecordByDateActivity.this));
		// db.close();
		if (recordList != null && recordList.size() > 0) {
			txtNote.setVisibility(View.GONE);
			adapter = new MRCAdapter(ClinicRecordByDateActivity.this, recordList);
			...
			lvRecord.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> paret, View view,
					...
					String gonStr = GsonUtil.getJsonValue((MRClinic)adapter
							.getItem(position));
					StringUtil.saveInfo(ClinicRecordByDateActivity.this, "record",
							gonStr);
					intent.putExtra("MRCId", ((MRClinic)adapter
							.getItem(position)).getIdLocal());
					startActivity(intent);
				}
			});
			lvRecord.setOnItemLongClickListener(new OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> parent,
					...
					// TODO Auto-generated method stub
					new AlertDialog.Builder(ClinicRecordByDateActivity.this)
							.setMessage("删除")
	...
	public class UpdateMRCTask extends AsyncTask<Integer, String, Integer> {
		...
		protected Integer doInBackground(Integer... params) {
			...
			String result = HttpUtil.doPostForm(map, Constants.GETMRCLINICLIST,
					false, ClinicRecordByDateActivity.this);
		...
		protected void onPostExecute(Integer result) {
			...
			if (result == Constants.SUCCESS) {
				updateToDB(mrcList);
				initUI();
				AlertDialogUtil.showAlertDialog(ClinicRecordByDateActivity.this,
						"同步完成!");
			} else {
	...
	void showCustomProgrssDialog(String msg) {
		...
		if (null == m_customProgrssDialog)
			...
			.createProgrssDialog(ClinicRecordByDateActivity.this);
