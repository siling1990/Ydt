 ...
 * 
 */
public class AddMediaSpinActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String mrcStr = StringUtil.getInfo(AddMediaSpinActivity.this, "record", "");
		...
		headBack.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				AddMediaSpinActivity.this.finish();
			}
		});
		...
		// 建立数据源
		mItems = getResources().getStringArray(R.array.bsname);
		// 建立Adapter并且绑定数据源
	...
	public void onClick(View view) {
		...
		case R.id.natives:
			myCaptureFile = FileUtil
					.refileG(AddMediaSpinActivity.this, filter+headBs.getSelectedItemPosition()+"-", src);
		...
		case R.id.pai:
			...
			break;
		case R.id.yuyin:
			intent = new Intent(AddMediaSpinActivity.this, RecorderActivity.class);
			...
			break;
		case R.id.wenzi:
			intent = new Intent(AddMediaSpinActivity.this, IatActivity.class);
			intent.putExtra("src", src);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == Constants.PHOTORESOULT) {
			...
			if (extras != null) {
				...
				// 自动生成图片
				img = new ImageView(AddMediaSpinActivity.this);
				img.setTag(src);
				...
				try {
					if (myCaptureFile == null) {
						myCaptureFile = FileUtil.refileG(AddMediaSpinActivity.this,
								filter, src);
					}
					if (Environment.getExternalStorageState().equals(
						...
						Toast toast = Toast.makeText(AddMediaSpinActivity.this,
